    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Savings summary / Graphs placeholders -->
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 col-span-1 lg:col-span-1">
                    <h4 class="font-semibold">Savings & Analytics</h4>
                    <p class="text-sm text-gray-500 mb-4">High-level savings metrics and graphs (placeholders).</p>
